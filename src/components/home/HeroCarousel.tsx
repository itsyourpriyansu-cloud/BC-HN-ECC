...
export default function HeroCarousel() {
  const images = [
    "https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?auto=format&fit=crop&w=1600&q=80", // bedsheets
    "https://images.unsplash.com/photo-1583847268964-b28dc8f51f92?auto=format&fit=crop&w=1600&q=80", // quilts
    "https://images.unsplash.com/photo-1584100936595-c0654b55a2e2?auto=format&fit=crop&w=1600&q=80", // cushions
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center relative z-20">
        <div className="max-w-xl sm:max-w-2xl flex flex-col gap-5 items-start">
          ...
          <h1 className="font-serif text-4xl sm:text-6xl font-extrabold text-alemah-espresso leading-tight animate-fade-in">
            Pure Textile Art.
            <br />
            <span className="text-alemah-red-600 italic font-semibold">
              Legacy Craft.
            </span>
          </h1>
